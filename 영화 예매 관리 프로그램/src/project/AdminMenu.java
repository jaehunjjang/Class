...
import java.util.ArrayList;	//새로 추가된 코드

public class AdminMenu extends AbstractMenu { //AbstractMenu를 상속받음
	...
	public Menu next() {
		...
		case "b" : return prevMenu;			//b 입력 시, 이전 메뉴를 반환
		default : return this;
		}
	}
	...
	private void createMovie() {
		...
		String title = scanner.nextLine();			//제목입 입력
